...
export default async function handler(
  ...
  authMiddleware(req, res, async () => {
    // Then check role
    requireRole("admin", "manager")(req, res, async () => {
...
The Monarcho Events Team`;
              ...
              if (emailResult.error) {
                ...
                console.log(
                  `Completion email sent successfully to ${updatedBooking.email}:`,
              ...
              console.warn(
                "Booking updated successfully but completion email failed"
              );
            }
          }
          ...
          return res.status(200).json({
            ...
            message: `Booking status updated to ${normalizedStatus}${
              normalizedStatus === "DONE" ? " and completion email sent" : ""
            }`,
            data: {
